...
void classRF(double *x, int *dimx, int *cl, int *ncl, int *cat, int *maxcat,
    ...
    printf("\n");*/
    tgini =      (double *) calloc(mdim, sizeof(double));
    wl =         (double *) calloc(nclass, sizeof(double));
    wr =         (double *) calloc(nclass, sizeof(double));
    classpop =   (double *) calloc(nclass* *nrnodes, sizeof(double));
    tclasscat =  (double *) calloc(nclass*32 ,sizeof(double));
    tclasspop =  (double *) calloc(nclass , sizeof(double));
    tx =         (double *) calloc(nsample , sizeof(double));
    win =        (double *) calloc(nsample , sizeof(double));
    tp =         (double *) calloc(nsample , sizeof(double));
    out =           (int *) calloc(nsample , sizeof(int));
    bestsplitnext = (int *) calloc(*nrnodes , sizeof(int));
    bestsplit =     (int *) calloc(*nrnodes , sizeof(int));
    nodepop =       (int *) calloc(*nrnodes , sizeof(int));
    nodestart =     (int *) calloc(*nrnodes , sizeof(int));
    jin =           (int *) calloc(nsample , sizeof(int));
    nodex =         (int *) calloc(nsample , sizeof(int));
    nodexts =       (int *) calloc(ntest , sizeof(int));
    ta =            (int *) calloc(nsample , sizeof(int));
    ncase =         (int *) calloc(nsample , sizeof(int));
    jerr =          (int *) calloc(nsample , sizeof(int));
    varUsed =       (int *) calloc(mdim , sizeof(int));
    jtr =           (int *) calloc(nsample , sizeof(int));
    jvr =           (int *) calloc(nsample , sizeof(int));
    classFreq =     (int *) calloc(nclass , sizeof(int));
    jts =           (int *) calloc(ntest , sizeof(int));
    idmove =        (int *) calloc(nsample , sizeof(int));
    at =            (int *) calloc(mdim*nsample , sizeof(int));
    a =             (int *) calloc(mdim*nsample , sizeof(int));
    b =             (int *) calloc(mdim*nsample , sizeof(int));
    mind =          (int *) calloc(mdim , sizeof(int));
    nright =        (int *) calloc(nclass , sizeof(int));
    nrightimp =     (int *) calloc(nclass , sizeof(int));
    nout =          (int *) calloc(nclass , sizeof(int));
    if (oobprox) {
        oobpair = (int *) calloc(near*near , sizeof(int));
    }
    ...
    if (stratify) {
        ...
        strata_size = (int  *) calloc(nstrata , sizeof(int));
        for (n = 0; n < nsample0; ++n) {
            strata_size[strata[n] - 1] ++;
        }
        strata_idx =  (int **) calloc(nstrata , sizeof(int *));
        for (n = 0; n < nstrata; ++n) {
            strata_idx[n] = (int *) calloc(strata_size[n] , sizeof(int));
        }
    ...
    if (labelts) {
        nclts  = (int *) calloc(nclass , sizeof(int));
...
void oob(int nsample, int nclass, int *jin, int *cl, int *jtr, int *jerr,
    ...
    noobcl  = (int *) calloc(nclass , sizeof(int));
